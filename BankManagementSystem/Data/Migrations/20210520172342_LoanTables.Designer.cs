...
namespace BankManagementSystem.Data.Migrations
{
    ...
    [Migration("20210520172342_LoanTables")]
    partial class LoanTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankManagementSystem.Models.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("IdentificationProofType")
                        .HasColumnType("int");

                    b.Property<string>("NomineeAccountNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BankManagementSystem.Models.EducationLoan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankManagementSystem.Models.PersonalLoan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("TotalExperienceWithCurrentCompany")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BankManagementSystem.Models.ApplicationUser", b =>
                {
                    b.HasOne("BankManagementSystem.Models.BankAccount", "BankAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("BankManagementSystem.Models.EducationLoan", b =>
                {
                    b.HasOne("BankManagementSystem.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
